...
export default function OmniFlixPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <Header chainName="omniflixhub" />
      <main className="flex-1 space-y-4 p-8 pt-6">
        <div className="flex items-center justify-between">
          <h1 className="text-3xl font-bold">OmniFlix Dashboard</h1>
        </div>
        ...
        {!status || status === 'Disconnected' ? (
          <Alert>
            ...
            <AlertDescription>
              Connect your wallet to view your OmniFlix balances and rewards
            </AlertDescription>
          </Alert>
        ) : (
          <>
            <div className="grid gap-4 md:grid-cols-4">
              ...
              <StatsCard
                ...
                description="Total value of all FLIX"
                isLoading={isLoading}
                tokenSymbol="FLIX"
                chainName="omniflixhub"
              />
            ...
            <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
              <DelegationsCard chainName="omniflixhub" />
              <RewardsChart chainName="omniflixhub" />
            </div>

            <ChainInfo chainName="omniflixhub" />
          </>
        )}
      </main>
    </div>
