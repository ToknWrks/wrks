...
export default function RegenPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <Header chainName="regen" />
      <main className="flex-1 space-y-4 p-8 pt-6">
        <div className="flex items-center justify-between">
          <h1 className="text-3xl font-bold">Regen Dashboard</h1>
        </div>
        ...
        {!status || status === 'Disconnected' ? (
          <Alert>
            ...
            <AlertDescription>
              Connect your wallet to view your Regen balances and rewards
            </AlertDescription>
          </Alert>
        ) : (
          <>
            <div className="grid gap-4 md:grid-cols-4">
              ...
              <StatsCard
                ...
                description="Total REGEN staked"
                isLoading={isLoading}
                tokenSymbol="REGEN"
                chainName="regen"
              />
              ...
              <StatsCard
                ...
                description="Total value of all REGEN"
                isLoading={isLoading}
                tokenSymbol="REGEN"
                chainName="regen"
              />
            ...
            <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
              <DelegationsCard chainName="regen" />
              <RewardsChart chainName="regen" />
            </div>

            <ChainInfo chainName="regen" />
          </>
        )}
      </main>
    </div>
